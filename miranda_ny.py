...
filtered_df = df[['headline','working_hours_type.label', 'workplace_address.region', 
                'workplace_address.municipality', 'duration.label']].astype(str)
...
if search_query:
    df[['headline', 
                                   'working_hours_type.label', 'workplace_address.region', 
                                   'workplace_address.municipality', 'duration.label']] = df[['headline', 
                                   'working_hours_type.label', 'workplace_address.region', 
                                   'workplace_address.municipality', 'duration.label']].astype(str)
    filtered_df = df[df[['headline', 
                                   'working_hours_type.label', 'workplace_address.region', 
                                   'workplace_address.municipality', 'duration.label']].str.contains(search_query, case=False)]
    st.write(filtered_df)
else:
    filtered_df = df
